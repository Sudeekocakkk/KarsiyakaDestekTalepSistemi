  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-lg font-semibold text-slate-800">Taleplerim</h1>
          <p className="text-sm text-slate-500">Oluşturduğunuz destek taleplerini görüntüleyin.</p>
        </div>
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-slate-100 text-xs uppercase tracking-wide text-slate-400">
                  ...
                  <th className="sticky top-0 z-10 bg-white pb-2 pr-4">Kategori</th>
              ...
              <tbody>
                {tickets.map((ticket) => (
                  <tr key={ticket.id} className="border-b border-slate-50 last:border-0 hover:bg-slate-50">
                    ...
                    <td className="py-2.5 pr-4 text-slate-500">{ticket.category?.name}</td>
                    <td className="py-2.5 pr-4">
